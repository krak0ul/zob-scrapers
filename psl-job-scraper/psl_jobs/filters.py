...
from psl_jobs.contract_types import CONTRACT_GROUPS
...
class AdvancedFilterConfig:
    ...
    def from_yaml(cls, path: str) -> "AdvancedFilterConfig":
        ...
        return cls(
            ...
            etablissements= [str(v) for v in (f.get("etablissements") or [])],
        )
    ...
    def from_kwargs(cls, kwargs: dict) -> "AdvancedFilterConfig":
        ...
        return cls(
            ...
            etablissements= _split(kwargs.get("etablissements", "")),
        )
